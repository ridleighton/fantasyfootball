...
export async function load({ cookies }) {
  ...
  if (session) {
    ...
    try {
      ...
      await db.query(`CREATE TABLE IF NOT EXISTS fantasy_leagues (id SERIAL PRIMARY KEY, sport TEXT NOT NULL DEFAULT 'Football', platform TEXT NOT NULL, commissioner_name TEXT NOT NULL, league_name TEXT NOT NULL, url TEXT NOT NULL, sort_order INTEGER DEFAULT 0, expiration_date DATE, winner TEXT, created_at TIMESTAMPTZ DEFAULT NOW())`).catch(() => {});
